...
public class State {	
	 ...
	 */
	public State(TachoPilot my_navi, EOPD my_left, EOPD my_centre, EOPD my_right, boolean debug) {
		...
		// start timer
		timer = new Timer(1, new Tick(this.debug));
		timer.start();
	}
	// }}}
	...
	class Tick implements TimerListener {
		...
		public void timedOut() {
			...
			readTacho();
			readEOPDs();
			if(debug) System.out.println(left_dist + ":" + centre_dist + ":" + right_dist);
		}
	}
}
